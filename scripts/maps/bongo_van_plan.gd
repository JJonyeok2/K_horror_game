...
const SETTLEMENT_OFFICE_PLAYER_POSITION := Vector3(64.0, 1.34, 276.0)
const SETTLEMENT_OFFICE_ORIGIN := Vector3(64.0, 0.0, 276.0)
const SETTLEMENT_STATION_NAME = "BongoSettlementStation"
const SETTLEMENT_STATION_POSITION := Vector3(64.0, 1.05, 273.35)
const SETTLEMENT_STATION_SIZE := Vector3(1.0, 0.82, 0.48)
