...
const SETTLEMENT_MAP_SELECTOR_NAME = "BongoSettlementMapSelector"
const SETTLEMENT_MAP_SELECTOR_POSITION := Vector3(1.08, 1.05, 275.45)
const SETTLEMENT_MAP_SELECTOR_SIZE := Vector3(0.72, 0.42, 0.36)
const DEPARTURE_BUTTON_NAME = "BongoDepartureButton"
const DEPARTURE_BUTTON_POSITION := Vector3(-1.1, 1.05, 275.45)
const DEPARTURE_BUTTON_SIZE := Vector3(0.62, 0.42, 0.36)
const STORED_CARGO_START_POSITION := Vector3(-0.95, 0.72, 272.65)

const SETTLEMENT_OFFICE_PLAYER_POSITION := Vector3(64.0, 1.34, 288.0)
const SETTLEMENT_OFFICE_ORIGIN := Vector3(64.0, 0.0, 276.0)
const SETTLEMENT_OFFICE_FLOOR_SIZE := Vector3(48.0, 0.32, 36.0)
const SETTLEMENT_STATION_NAME = "BongoSettlementStation"
const SETTLEMENT_STATION_POSITION := Vector3(64.0, 1.05, 263.15)
const SETTLEMENT_STATION_SIZE := Vector3(1.5, 0.9, 0.7)
const SETTLEMENT_BONGO_PARKING_PAD_POSITION := Vector3(64.0, -0.03, 247.5)
const SETTLEMENT_BONGO_PARKING_PAD_SIZE := Vector3(16.0, 0.24, 22.0)
const SETTLEMENT_BONGO_ORIGIN := Vector3(64.0, 0.44, 251.7)
const SETTLEMENT_BONGO_RETURN_BUTTON_NAME = "SettlementOfficeBongoReturnButton"
const SETTLEMENT_BONGO_RETURN_BUTTON_POSITION := Vector3(64.0, 1.08, 255.25)
const SETTLEMENT_BONGO_RETURN_BUTTON_SIZE := Vector3(0.82, 0.42, 0.36)
