...
namespace KHorrorGame.EditorTools
{
    public static class KHorrorInternalPlayflowReport
    {
            ...
            FileInfo screenshot)
        {
            ...
            builder.AppendLine("- Terminal UX proof: `terminal states -> depart -> traveling -> return -> settle`, `unavailable while traveling`");
            builder.AppendLine("- Travel sequence proof: `travel fade -> generated bongo engine hum -> motion shake`");
